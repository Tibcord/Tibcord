...
/**
* Represents an Tibcord client with the command framework
* @extends Client
...
class CommandClient extends Client {
    ...
    * @arg {Object} options Tibcord options (same as Client)
    ...
    * @arg {String} [commandOptions.description="An Tibcord-based Discord bot"] The description to show in the default help command
    ...
    */
    constructor(token, options, commandOptions) {
        ...
        this.commandOptions = Object.assign({
            ...
            description: "An Tibcord-based Discord bot",
            ignoreBots: true,
            ignoreSelf: true,
            name: null,
