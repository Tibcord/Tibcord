...
/**
* Represents an apoloJS client with the command framework
* @extends Client
...
class CommandClient extends Client {
    ...
    * @arg {Object} options apoloJS options (same as Client)
    ...
    * @arg {String} [commandOptions.description="An apoloJS-based Discord bot"] The description to show in the default help command
    ...
    */
    constructor(token, options, commandOptions) {
        ...
        this.commandOptions = Object.assign({
            ...
            description: "An apoloJS-based Discord bot",
            ignoreBots: true,
            ignoreSelf: true,
            name: null,
