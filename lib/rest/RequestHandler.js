...
class RequestHandler {
    constructor(client, options) {
        ...
        this._client = client;
        this.userAgent = `DiscordBot (https://github.com/Tibcord/Tibcord, ${require("../../package.json").version})`;
        this.ratelimits = {};
        this.latencyRef = {
    ...
    */
    request(method, url, auth, body, file, _route, short, token) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const actualCall = (cb) => {
                ...
                try {
                    if(auth) {
                        headers.Authorization = this._client._token || token;
                    }
